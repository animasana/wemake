...
-- CREATE TYPE "public"."product_stages" AS ENUM('idea', 'prototype', 'mvp', 'product');--> statement-breakpoint
-- CREATE TYPE "public"."notification_types" AS ENUM('follow', 'review', 'reply', 'mention');--> statement-breakpoint
-- CREATE TYPE "public"."roles" AS ENUM('developer', 'designer', 'marketer', 'founder', 'product-manager');--> statement-breakpoint
-- CREATE TABLE "events" (
...
-- ALTER TABLE "products" ADD CONSTRAINT "products_to_profiles" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("profile_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
