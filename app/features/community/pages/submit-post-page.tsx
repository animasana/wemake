  ...
  return (
    <div className="space-y-20">
      <Hero
        ...
        subtitle="Ask questions, share ideas, and connect with other makers."
      />
      <Form className="flex flex-col gap-10 max-w-screen-md mx-auto" method="post"> 
        ...
        <InputPair
          ...
          required          
          placeholder="i.e. I'm looking for a productivity tool that can help me manage my time and tasks. What are the best tools out there?"
          textArea
        />
        {actionData && "fieldErrors" in actionData && (
          <div className="text-red-500">
