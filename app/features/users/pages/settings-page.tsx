...
export default function SettingsPage({ 
  ...
  const isVisible = actionData?.formErrors && "role" in actionData?.formErrors;
      ...
      <div className="grid grid-cols-6 gap-40">
        ...
        >
          ...
          <div className="space-y-5">
            ...
            <Activity mode={actionData?.formErrors && "avatar" in actionData?.formErrors ? "visible" : "hidden"}>
              <Alert>
                <AlertTitle>Error</AlertTitle>
                <AlertDescription>
                  {(actionData?.formErrors as { avatar: string[] })?.avatar?.join(", ")}
                </AlertDescription>
              </Alert>              
            </Activity>
